...
const PARTY_DATA = {
  ...
  facts: [
    ...
    { fact: "[James fact 1]",   guestId: "james"   },
    { fact: "[James fact 2]",   guestId: "james"   },
    { fact: "[Hayden fact 1]",  guestId: "hayden"  },
    { fact: "[Hayden fact 2]",  guestId: "hayden"  },
    { fact: "[Kimberly fact 1]",guestId: "kimberly"},
    { fact: "[Kimberly fact 2]",guestId: "kimberly"},
    { fact: "[Prital fact 1]",  guestId: "prital"  },
    { fact: "[Prital fact 2]",  guestId: "prital"  },
    { fact: "[Tyler fact 1]",   guestId: "tyler"   },
    { fact: "[Tyler fact 2]",   guestId: "tyler"   },
    { fact: "[Logan fact 1]",   guestId: "logan"   },
    { fact: "[Logan fact 2]",   guestId: "logan"   },
    { fact: "[Hairam fact 1]",  guestId: "hairam"  },
    { fact: "[Hairam fact 2]",  guestId: "hairam"  },
    { fact: "[Meagan fact 1]",  guestId: "meagan"  },
    { fact: "[Meagan fact 2]",  guestId: "meagan"  },
    { fact: "[Jessica fact 1]", guestId: "jessica" },
    { fact: "[Jessica fact 2]", guestId: "jessica" },
    { fact: "[Diego fact 1]",   guestId: "diego"   },
    { fact: "[Diego fact 2]",   guestId: "diego"   },
    { fact: "[Trenton fact 1]", guestId: "trenton" },
    { fact: "[Trenton fact 2]", guestId: "trenton" },
    { fact: "[Lucas fact 1]",   guestId: "lucas"   },
    { fact: "[Lucas fact 2]",   guestId: "lucas"   },
  ],
